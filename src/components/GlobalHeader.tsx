...
export default function GlobalHeader({
  ...
  return (
    <div className="relative sm:sticky sm:top-0 z-40 card-glass p-6 mb-6 print:hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm transition-all duration-200 border-b border-gray-100 dark:border-gray-800">
